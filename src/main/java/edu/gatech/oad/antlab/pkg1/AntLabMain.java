 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Julian Mancini");
		  toPrint += p1.toString("jmancini6");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Madison McRoy");
		  toPrint += p2.toString("mmcroy3");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Ryan Power");
		  toPrint += p3.toString("jpower30");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Edward Jackson");
                  toPrint += p4.toString("ejackson61");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Nate Knauf");
                  toPrint += p5.toString("nknauf3");
